...
const testimonials = [
  {
    ...
    image: "https://askproject.net/evecon/wp-content/uploads/sites/126/2023/01/millennials-multiracial-guys-showing-various-emoti2-T7HDT9D.jpg",
    rating: 5,
...
const CustomPrevArrow = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        <path d="M15.54 18.54L8.24 12l7.3-6.54a1.5 1.5 0 1 0-2.12-2.12L4.5 12l8.92 8.66a1.5 1.5 0 1 0 2.12-2.12z" fill='black'/>
      </svg>
    </div>
  );
};
  ...
  return (
    ...
    >
      <svg
        ...
        className="w-6 h-6 text-black"
      >
        <path d="M8.46 18.54L15.76 12l-7.3-6.54a1.5 1.5 0 1 1 2.12-2.12L19.5 12l-8.92 8.66a1.5 1.5 0 1 1-2.12-2.12z" fill='black'/>
      </svg>
    </div>
  );
};
      ...
      <Slider {...settings}>
        {testimonials.map((testimonial, index) => (
          <div key={index} className="px-4">
            <div className="p-6 text-center bg-[#EBE8FF]">
              <img 
